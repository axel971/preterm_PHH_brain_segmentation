...
# 		gt_segmentation[gt_segmentation == 7] = 0 # Hack: the ground segmentations have one volume in add compared to the predicted segmentation	
	...
	predicted_segmentation_dir = '/home/axel/dev/neonatal_brain_segmentation/data/output/bayesian_UNet/dropout_encoder_decoder/p_02/prediction/allVOI_cross_entropy_loss'
	...
	for iSubject in range(0, n_subject):
		...
		save_image(difference_maps[iSubject], affines[iSubject], '/home/axel/dev/neonatal_brain_segmentation/data/output/bayesian_UNet/dropout_encoder_decoder/p_02/difference_map/' + subject_names[iSubject] + '_difference_map.nii')
    	
	# Get the uncertainty maps
	uncertainty_dir = '/home/axel/dev/neonatal_brain_segmentation/data/output/bayesian_UNet/dropout_encoder_decoder/p_02/predictive_entropy/allVOI_cross_entropy_loss/'
	...
	data_AUC.to_csv('/home/axel/dev/neonatal_brain_segmentation/data/output/bayesian_UNet/dropout_encoder_decoder/p_02/AUC_uncertainty/uncertainty_AUC.csv')
	
	data_mean_recall = pd.DataFrame(mean_recall)
	data_mean_recall.to_csv('/home/axel/dev/neonatal_brain_segmentation/data/output/bayesian_UNet/dropout_encoder_decoder/p_02/mean_recall_uncertainty/mean_recall.csv')
	
	data_mean_FPR = pd.DataFrame(mean_FPR)
	data_mean_FPR.to_csv('/home/axel/dev/neonatal_brain_segmentation/data/output/bayesian_UNet/dropout_encoder_decoder/p_02/mean_FPR_uncertainty/mean_FPR.csv')
    
    	
	data_optimal_threshold = pd.DataFrame(opt_threshold)
	data_optimal_threshold.to_csv('/home/axel/dev/neonatal_brain_segmentation/data/output/bayesian_UNet/dropout_encoder_decoder/p_02/opt_threshold_uncertainty/opt_threshold_uncertainty.csv')
