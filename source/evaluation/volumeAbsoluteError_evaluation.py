...
print('Process: volume absolute error')
...
volumeAbsoluteError_dir = '/home/axel/dev/neonatal_brain_segmentation/data/output/ensembleLearning/volumeAbsoluteError/volumeAbsoluteError.csv'
...
# delineation_dir = '/home/axel/dev/neonatal_brain_segmentation/data/delineations/case/preprocessing/allVOIs'
# volumeAbsoluteError_dir = '/home/axel/dev/neonatal_brain_segmentation/data/output/U-Net/experiment1/volumeAbsoluteError/volumeAbsoluteError.csv'
...
for n in range(n_subject):
	...
	volumeAbsoluteError.append(metrics.volumeAbsoluteError_multi_array(delineation1, delineation2, labels, voxel_spacing))
