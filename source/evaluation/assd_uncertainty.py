...
def main():
	...
	assd_uncertainty_dir = '/home/axel/dev/neonatal_brain_segmentation/data/output/bayesian_UNet/dropout_decoder/p_05/assd_uncertainty/assd_uncertainty.csv'
	...
	for iSubject in range(n_subject):
		...
		assd_uncertainty.append(uncertainty.assd_uncertainty(MCsamples, labels, voxel_spacing))

	
	data = pandas.DataFrame(assd_uncertainty)	
	data.to_csv(assd_uncertainty_dir)
