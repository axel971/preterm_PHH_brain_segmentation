...
def main():
    ...
    for iFold in range(nFold):
    	...
    	model = tf.keras.models.load_model('/home/axel/dev/neonatal_brain_segmentation/data/output/bayesian_UNet/dropout_encoder_decoder/p_02/models/model_' + str(iFold) + '.h5', custom_objects = {'dice_multi': metrics.dice_multi})    	
    	...
    	for i in range(len(test_id)):
    		...
    		np.save('/home/axel/dev/neonatal_brain_segmentation/data/output/bayesian_UNet/dropout_encoder_decoder/p_02/MCsamples/allVOI_cross_entropy_loss/'+ subject_names[test_id[i]] + '_MCsamples.npy', MCsamples)
    		save_image(prediction, affines[test_id[i]],  '/home/axel/dev/neonatal_brain_segmentation/data/output/bayesian_UNet/dropout_encoder_decoder/p_02/prediction/allVOI_cross_entropy_loss/' + subject_names[test_id[i]] + '_predicted_segmentation.nii')
