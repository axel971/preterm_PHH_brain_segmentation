...
def main():
    ...
    single_model = bayesian_Unet3d(patch_size + [1], len(labels), 0.1)
    ...
    model.fit_generator(generator=training_generator, epochs = 80, verbose = 2)
    end_training_time = time.time()	
    print('training time: ' + str(end_training_time - start_training_time))
    	
    model.save('/home/axel/dev/neonatal_brain_segmentation/data/output/bayesian_UNet/dropout_encoder_decoder/p_01/models/model_training_whole_cohort.h5')
