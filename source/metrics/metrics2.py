...
def hd95_multi_array(y_true, y_pred, labels, voxelspacing = None):
    n_labels = len(labels)
    hd95_value = numpy.zeros(n_labels, dtype=numpy.float32)
    ...
    for i in range(n_labels):
        ...
        # print(yi_true.shape)
        # print(yi_true.dtype)
        hd95_value[i] = hd95(yi_pred, yi_true, voxelspacing)
...
def assd_multi_array(y_true, y_pred, labels, voxelSpacing = None):
    n_labels = len(labels)
    assd_value = numpy.zeros(n_labels, dtype=numpy.float32)
    ...
    for i in range(n_labels):
        ...
        # print(yi_true.shape)
        # print(yi_true.dtype)
        assd_value[i] = assd(yi_pred, yi_true, voxelSpacing)
